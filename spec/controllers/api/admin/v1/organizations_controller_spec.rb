...
RSpec.describe Api::Admin::V1::OrganizationsController, type: :controller do
  ...
  # Api::Admin::V1::OrganizationsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new api/admin/v1_organization" do
        ...
        expect(response.location).to eq(api/admin/v1_organization_url(Organization.last))
      end
    end
