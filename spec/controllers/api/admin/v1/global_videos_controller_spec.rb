...
RSpec.describe Api::Admin::V1::GlobalVideosController, type: :controller do
  ...
  # Api::Admin::V1::GlobalVideosController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "returns a success response" do
      global_video = GlobalVideo.create! valid_attributes
      get :show, params: {id: global_video.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new GlobalVideo" do
        ...
        }.to change(GlobalVideo, :count).by(1)
      end
      ...
      it "renders a JSON response with the new api/admin/v1_global_video" do
        ...
        expect(response.location).to eq(api/admin/v1_global_video_url(GlobalVideo.last))
      end
    end
