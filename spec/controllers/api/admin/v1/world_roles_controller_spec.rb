...
RSpec.describe Api::Admin::V1::WorldRolesController, type: :controller do

  # This should return the minimal set of attributes required to create a valid
  # WorldRole. As you add validations to WorldRole, be sure to
  ...
  # Api::Admin::V1::WorldRolesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "returns a success response" do
      world_role = WorldRole.create! valid_attributes
      get :show, params: {id: world_role.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new WorldRole" do
        ...
        }.to change(WorldRole, :count).by(1)
      end
      ...
      it "renders a JSON response with the new api/admin/v1_world_role" do
        ...
        expect(response.location).to eq(api/admin/v1_world_role_url(WorldRole.last))
      end
    end
