...
ActiveRecord::Schema.define(version: 2020_08_10_085455) do
  ...
  create_table "adaptive_contents", force: :cascade do |t|
    t.string "title"
    t.text "description"
    t.string "adaptable_type", null: false
    t.bigint "adaptable_id", null: false
    t.string "contentable_type", null: false
    t.bigint "contentable_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["adaptable_type", "adaptable_id"], name: "index_adaptive_contents_on_adaptable_type_and_adaptable_id"
    t.index ["contentable_type", "contentable_id"], name: "index_adaptive_contents_on_contentable_type_and_contentable_id"
  end
