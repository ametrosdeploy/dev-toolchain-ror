...
class Api::Admin::V1::AdaptiveContentsController < Api::Admin::V1::BaseController
  ...
  before_action :set_adaptive_content, only: %i[update destroy]
  ...
  swagger_api :update do
    ...
    notes 'Should be used to update an adaptive content'
    param :header, :Authorization, :string, :required, 'Authorization'
  ...
  def create_or_update_adaptive_contents
    if content_type
  ...
  def set_adaptive_content
    ...
    @adaptable = @adaptive_content.adaptable
  end
