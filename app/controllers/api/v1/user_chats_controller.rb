...
class Api::V1::UserChatsController < Api::V1::BaseController
  ...
  def evaluate
    ...
    if @user_chat.user_chat_messages.present? && handler.evaluate
  ...
  swagger_controller :user_chats, 'User Chats'
  ...
  swagger_api :evaluate do
    ...
    param :path, 'id', :integer, :required, USER_CHAT_ID
  end
  ...
  swagger_api :create do
    ...
    param :header, :Authorization, :string, :required, 'Authorization'
    param :form, 'user_chat[user_learn_obj_id]', :integer, :required,
          'User Learn Obj ID'
...
=end
  ...
  swagger_api :show do
    ...
    param :header, :Authorization, :string, :required, 'Authorization'
    param :path, 'id', :string, :required, USER_CHAT_ID
  end
