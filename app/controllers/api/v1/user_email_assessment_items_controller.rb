...
=begin
  swagger_controller :user_email_assessment_items, 'User Email Assessment Items'


  swagger_api :index do
    summary 'Get all learner email assessment items for a given User Email Evaluation'
